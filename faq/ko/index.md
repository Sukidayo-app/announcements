...
실수로 새로운 계정으로 시작해 버린 경우, 튜토리얼 상단 왼쪽의 점 세 개(…)에서 로그아웃 또는 계정 삭제를 진행한 후, 계정을 확인하여 다시 로그인해 주세요.

또한, 일부 튜토리얼 화면에서는 상단의 점 세 개가 표시되지 않는 경우가 있습니다. 그 경우에는 번거로우시겠지만 점 세 개를 선택할 수 있는 화면까지 튜토리얼을 진행해 주시기 바랍니다.
...
- 매월 「두 사람의 추억」 사진 수가 1인당 30장으로 증가
