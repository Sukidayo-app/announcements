...
Antes del lanzamiento, os contamos cómo va a cambiar.
...
## 🏡 ¡Llega el Carné de residente a Mi página!

Cuando registréis vuestro aniversario, aparecerá un **Carné de residente** en Mi página ✨

¿Queréis saber qué aspecto tiene? Registrad vuestro aniversario y **descubridlo vosotros mismos** 👀
...
El lanzamiento está previsto para muy pronto. Os avisaremos de nuevo cuando todo esté listo.

Si tras el lanzamiento el nuevo diseño no aparece, es posible que tu aplicación necesite actualizarse. Por favor, actualiza Riamo a la última versión.
